                            ...
                            return Card(
                              ...
                              child: ListTile(
                                ...
                                trailing: ValueListenableBuilder(
                                  valueListenable:
                                      Hive.box('favorit').listenable(),
                                  builder: (context, favBox, _) {

                                    final sessionBox = Hive.box('session');
                                    final String userId = sessionBox
                                            .get('email')
                                            ?.toString()
                                            .trim() ??
                                        'unknown_user';
                                    ...
                                    return IconButton(
                                      ...
                                      onPressed: () async {
                                        if (isFavorite) {
                                          await favBox.delete(favKey);
                                          ScaffoldMessenger.of(context)
                                              .showSnackBar(
                                            SnackBar(
                                              content: Text(
                                                  '${job.job_title} dihapus dari favorit'),
                                          ...
                                          ScaffoldMessenger.of(context)
                                            ...
                                            SnackBar(
                                              content: Text(
                                                  '${job.job_title} ditambahkan ke favorit'),
